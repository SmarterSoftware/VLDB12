...
static const struct dropmsgstrings dropmsgstringarray[] = {
	...
	{RELKIND_ARRAY,
		ERRCODE_UNDEFINED_TABLE,
		gettext_noop("timeseries \"%s\" does not exist"),
		gettext_noop("timeseries \"%s\" does not exist, skipping"),
		gettext_noop("\"%s\" is not a timeseries"),
	gettext_noop("Use DROP TIMESERIES to remove a timeseries.")},
	{RELKIND_SEQUENCE,
		ERRCODE_UNDEFINED_TABLE,
...
/*
 * RemoveRelations
 *		Implements DROP TABLE, DROP INDEX, DROP SEQUENCE, DROP VIEW, DROP TIMESERIES
 */
void
