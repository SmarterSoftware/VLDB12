			 ...
			 ParamListInfo params, DestReceiver* dest)
{
	...
	case 1:{
		TupOutputState	*tstate;
		char *s = palloc0(sizeof(char)*10);
		tstate = begin_tup_output_tupdesc(dest, ExplainResultDesc(NULL));
		getModelGraphRoot(false);
		sprintf(s,"%i",modelGraphIdx->models);
		releaseModelGraphRoot();
		do_text_output_multiline(tstate, s);
		end_tup_output(tstate);
		break;
	}
	}
	...
	switch(store)
			{
				...
				case 4:appendStringInfo(str, "ModelIndex,");break; //FAKEFLAG
				case 14:appendStringInfo(str, "Force ModelIndex,");break;
				default:break;
			}
			   ...
			   StringInfo str, int indent, ExplainState *es)
{
	...
	storeM=((CreateForecastModel*)cmplan)->modelInfo->storeModel;
			switch(storeM)
			{
				...
				case 3:appendStringInfo(str, "SystemTable,");break;
				case 13:appendStringInfo(str, "Force SystemTable,");break;
				case 4:appendStringInfo(str, "ModelIndex,");break;
				case 14:appendStringInfo(str, "Force ModelIndex,");break;
				default:break;
			}
