...
extern void transformFromClause(ParseState *pstate, List *frmList, int *t);
...
extern ForecastExpr *findTimeAndMeasureColumns(ParseState *pstate, ForecastExpr *expr, Query *query);
